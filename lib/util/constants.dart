...
//       'https://frontone-api.hepytech.com/api/banner/show?sortby=desc&orderby=id&per_page=5&page=1';
//   static const LevelUrl =
//       'https://frontone-api.hepytech.com/api/level/show?sortby=asc&orderby=id&per_page=5&page=1';
//   static const LoginUrl = 'https://frontone-api.hepytech.com/api/member/login';
//   static const RegisUrl =
//       'https://frontone-api.hepytech.com/api/member/register';
//   static const OrderUrl =
//       'https://frontone-api.hepytech.com/api/category-menu/show?sortby=asc&orderby=id&per_page=5&page=1';
// }
